...
function showTab(name){
  ...
  if(name==='earnings'){const ec=document.getElementById('earnings-content');if(!ec||ec.querySelector('.empty'))renderCurrentEarningsView();}
  if(name==='dashboard'){_syncDashboardViewModeUI();}
